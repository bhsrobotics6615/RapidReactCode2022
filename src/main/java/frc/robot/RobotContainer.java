...
private final TheFirst15 run_auto = new TheFirst15(drive_subsystem, launcher_subsystem, indexer_subsystem, draw_bridge_subsystem);
  ...
  //Xbox Controller Buttons: Port 1
  public JoystickButton Run_Launcher = new JoystickButton(Xbox360, Constants.RUN_LAUNCHER); // A Button
  public JoystickButton Run_Indexer = new JoystickButton(Xbox360, Constants.RUN_INDEXER);   // X Button
  public JoystickButton Run_BPU = new JoystickButton(Xbox360, Constants.RUN_BPU);           // B Button
  public JoystickButton Lower_BPU = new JoystickButton(Xbox360, Constants.LOWER_BPU);       // Start Button
  public JoystickButton Lift_BPU = new JoystickButton(Xbox360, Constants.LIFT_BPU);         // Back Button
  public JoystickButton Un_choke = new JoystickButton(Xbox360, Constants.CHOKING);          // Right Bumper
  public JoystickButton Auto_Launch = new JoystickButton(Xbox360, Constants.AUTO_LAUNCH);   // Y Button
  public JoystickButton stop_all = new JoystickButton(Xbox360, Constants.KILL_BUTTON);      // Right Joystick ???

  //Drive Controller Buttons: Port 0
  public JoystickButton Front_Climber_Extend = new JoystickButton(DriveController, Constants.FRONT_CLIMBER_EXTEND);   // X Button
  public JoystickButton Front_Climber_Retract = new JoystickButton(DriveController, Constants.FRONT_CLIMBER_RETRACT); // B Button
  public JoystickButton Back_Climber_Extend = new JoystickButton(DriveController, Constants.BACK_CLIMBER_EXTEND);     // A Button
  public JoystickButton Back_Climber_Retract = new JoystickButton(DriveController, Constants.BACK_CLIMBER_RETRACT);   // Y Button  
  public JoystickButton Lift_Auto_BPU = new JoystickButton(DriveController, Constants.Lift_Auto_BPU);                 // Back Button
  public JoystickButton Lower_Auto_BPU = new JoystickButton(DriveController, Constants.Lower_Auto_BPU);               // Start Button
  public JoystickButton climb = new JoystickButton(DriveController, Constants.CLAMBER_22);                            // Left Bumper
  public JoystickButton climb_climb = new JoystickButton(DriveController, Constants.CLAMBER_23);                      // Right Bumper
  ...
  private void configureButtonBindings() {
    ...
    Front_Climber_Extend.whenPressed(new ClimberStageThree(climber_subsystem)/*front_climber_extend*/); 
  ...
  /**
   * Use this to pass th
   * e autonomous command to the main {@link Robot} class.
   *
