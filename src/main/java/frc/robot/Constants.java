...
public final class Constants {
    ...
    public static final double LIMELIGHT_TARGET_Y = 3.0;

    // Search
    public static final double SEARCH_ROTATION_SPEED = 0.45;

    // Align
    public static final double ALIGN_ROTATION_SPEED = 0.15;
    public static final double ALIGN_MOVEMENT_SPEED = 0.25;
...
//     public static final int BALL_ENTERED = 7;
    ...
    // Launcher Run
    public static final double LAUNCH_RUN_TIME = 7;
    public static final double INDEX_TIME = 3.5;
