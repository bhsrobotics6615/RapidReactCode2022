...
public class ClimbSequence extends CommandBase {
  ...
  public void execute() {
    ...
    do {
      ...
      climber_subsystem.front_right_climber_extend();
      climber_subsystem.front_left_climber_extend();
    ...
    do {
      ...
      climber_subsystem.front_right_climber_retract();
      climber_subsystem.front_left_climber_retract();
