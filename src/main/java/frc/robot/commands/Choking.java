...
public class Choking extends CommandBase {
  @SuppressWarnings({"PMD.UnusedPrivateField", "PMD.SingularField"})
  private final LauncherSubsystem launch_subsystem;
  private final IndexerSubsystem indexer_subsystem;
  
  /** Creates a new Choking. */
  public Choking(LauncherSubsystem l_subsystem, IndexerSubsystem i_subsystem) {
  ...
  public void execute() {
    ...
    launch_subsystem.reverse();
    indexer_subsystem.unload();
